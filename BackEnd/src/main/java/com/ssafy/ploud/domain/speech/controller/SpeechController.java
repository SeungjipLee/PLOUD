...
import com.ssafy.ploud.domain.speech.dto.request.ClearitySpeedRequset;
...
public class SpeechController {
    ...
    public ApiResponse<?> clearitySpeech(@RequestParam("audioFile") MultipartFile audioFile) {
        ClearityResponse clearityResponse = speechService.clearityRating(audioFile);
...
//        return ApiResponse.error("평가 실패");
    ...
    @PostMapping("/clsp")
    public ApiResponse<?> clearitySpeedScore(@RequestParam ClearitySpeedRequset clearitySpeedRequset){

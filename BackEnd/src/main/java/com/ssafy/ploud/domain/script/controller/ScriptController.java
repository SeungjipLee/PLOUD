...
public class ScriptController {
  ...
  public ApiResponse<ScriptListResDto> getAllScriptListByCategory(
      @PathVariable("categoryId") int categoryId, @AuthenticationPrincipal UserDetails loginUser) {

    if (ScriptCategory.fromCategoryId(categoryId) == null) {
      return ApiResponse.failure("categoryId에 해당하는 카테고리가 존재하지 않습니다", ResponseStatus.NOT_FOUND);
    }

            ...
            <div className="mt-28">
              ...
              <div className="flex flex-col mx-60 bg-sky-100 ps-10 py-10 border border-black rounded-2xl mb-24">
                    <div className="flex mb-5">    
                        ...
                        <button className="ms-5 bg-blue-300 text-gray-200 rounded-xl px-2 py-1">직접 입력</button>
                        <button className="ms-3 bg-blue-500 text-white rounded-xl px-2 py-1">제공 대본</button>
                        <p className="ms-3 text-red-500">🎤준비된 대본들을 찾아 연습해보세요!</p>
                    </div>
                    <div className="flex mb-5">
                    ...
                    <div className="flex mb-5">    
                        ...
                        <button className="ms-5 bg-blue-500 text-white rounded-xl px-2 ">뉴스</button>
                        <button className="ms-3 bg-blue-300 text-gray-200 rounded-xl px-2 ">연설</button>
                    </div>
                    <div className="flex mb-10 w-full">    
                        ...
                        <div className="ms-5 border border-black rounded-2xl px-5 py-2 w-3/4 h-80 flex">
                            <div className="w-1/3 border-r border-black flex flex-col pe-4">
                                ...
                                <div className="m-2 bg-white h-64 rounded-xl p-4 h-64">목록 리스트</div>
                            </div>
                            <div className="w-2/3 ms-5 pb-5">
                                <div className="text-xl font-bold">미리보기</div>
                                <div className="m-2 bg-white h-64 rounded-xl p-4">미리보기 내용</div>
                            </div>
                        </div>
                    </div>
